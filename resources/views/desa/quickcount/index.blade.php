    ...
    <section class="p-3">
        ...
        <div class="d-lg-flex justify-content-between">
            ...
            @if ($quick_count->isEmpty())
                <a href="
                {{ route('koor.desa.quick_count.create', [$koordesa, $koortps]) }}"
        ...
        <div class="card p-3 mt-3">
            <form action="
            {{ route('koor.desa.quick_count.index', [$koordesa, $koortps]) }}" method="GET">
                ...
                <tbody>
                    ...
                    @foreach ($quick_count as $item)
                        <tr>
                            ...
                            <td>
                                <a href="
                            {{ route('koor.desa.quick_count.edit', [$koordesa, $koortps, $item]) }}"
