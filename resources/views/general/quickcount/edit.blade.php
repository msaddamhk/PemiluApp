...
@section('content')
    <section class="p-3">
        <form action="{{ route('quick_count.update', ['id_quick_count' => $quick_count->id]) }}" method="POST"
            ...
            <div class="mb-3">
                ...
                form-control"
                    value="{{ $quick_count->number_of_votes }}" required>
            ...
            <div class="mb-3">
                ...
                <input type="number" name="total_votes" class="form-control" value="{{ $quick_count->total_votes }}"
                    required>
                @error('total_votes')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
                ...
                <div>
                    ...
                    <label for="result_photo">
                        <div class="card p-2 mt-2">
                            <img id="frame"
                                src="{{ $quick_count->result_photo
                                    ? asset('storage/img/quick_count/' . $quick_count->result_photo)
