...
@section('content')
    <section class="p-3">
        <form action="{{ route('dpt.update', [$koorkota, $koorkecamatan, $koordesa, $dpt]) }}" method="POST">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="phone_number" value="{{ $dpt->phone_number }}" class="form-control" required>
            </div>
